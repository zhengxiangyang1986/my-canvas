...
> AI 节点画布工作流工具 · Web + Electron 桌面端｜v1.4.0
>
...
![status](https://img.shields.io/badge/version-v1.4.0-brightgreen) ![node](https://img.shields.io/badge/node-%E2%89%A518-blue) ![react](https://img.shields.io/badge/react-19-61dafb) ![electron](https://img.shields.io/badge/electron-33-47848f) ![license](https://img.shields.io/badge/license-MIT-yellow)
...
- 🌗 **主题模板系统**：科技风 / 像素糖果风 / OP 风格三套内置模板，支持浅色 / 深色、导入导出、编辑保存、自定义路径与默认静音主题音乐
...
产物：`dist_electron/T8-PenguinCanvas-Setup-<version>.exe`（v1.4.0 打包后以实际产物大小为准）
...
| 样式 | Tailwind CSS 3 · CSS Modules · 主题模板（科技风 / 像素糖果风 / OP 风格） |
